...
const PreviewGeneratedIamge = (props) => {
    ...
    return (
        <Div>
            <StoryText>{savedImageTemp[props.index]['fullStory']}</StoryText>
            ...
            >
                <Text isHovered={isHovered}>
                    {isHovered ? '각 페이지에 대한 이미지를 모두 생성해주어야 동화책을 만들러 갈 수 있어요!' : '안내'}
                </Text>
            </Guide>
