...
const Home = () => {
    ...
    return (
        <div>
            ...
            <LazyBackground type="home" src="https://ik.imagekit.io/hbcho/Girl.png" placeholder={base64_Girl} />
            <LazyBackgroundHome src="https://ik.imagekit.io/hbcho/CartoonStarryNight.png" placeholder={base64_Bg} />
        </div>
    );
};
